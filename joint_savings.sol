...
contract JointSavings {
    ...
    */
    function withdraw(uint amount, address payable recipient) public {
        ...
        */
        require(recipient == accountOne || recipient == accountTwo, "You don't own this account scrub!");
        ...
        */
        require(address(this).balance >= amount, "Insufficient funds mayne. Get your money up!");
